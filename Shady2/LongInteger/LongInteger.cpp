...
class LongInteger {
     ...
     {     
         ...
         for (int i = 1; i< QNode; i++)
         {
          ...
          int thisTempCount, QTempCount,numerator,denominator,differenceCount,numDivide,numDivideCount;
          
          
          Node* temp1 = X.GET_FIRST();
          Node* temp2 = Q.X.GET_FIRST();
          
          numerator = X.NODE_VALUE(temp1);
          denominator = Q.X.NODE_VALUE(temp2);
          
          if(X.GET_FIRST()!=X.GET_LAST())
           {
               cout << "\nhello1";
              numerator = numerator * 10000;
              temp1 = X.NEXT_RIGHT(temp1);
              numerator = numerator +X.NODE_VALUE(temp1);
           }
           
           if(Q.X.GET_FIRST()!= Q.X.GET_LAST())
           {
               cout << "\nhello2";
              denominator = denominator * 10000;
              temp2 = X.NEXT_RIGHT(temp2);
              denominator = denominator + X.NODE_VALUE(temp2);
           }
         ...
         cout << "\nhello6";
           ...
           remainder2 = Q.MULTIPLY(result);
           paddedsub.X.head = remainder2.X.head;
               
               while(remainder2.LESSTHAN(Q)){
                   cout << "\nhello5";
                   remainder2 = remainder2.MULTIPLY(scale10);
                      if(remainder2.LESSTHAN(Q)&& !remainder2.EQUALTO(Q))
                          paddedsub.X.head = remainder2.X.head;
                    } 
               
               remainder1 = SUBTRACT(paddedsub);
           
           //remainder1 = SUBTRACT(Q.MULTIPLY(result));
           
           
           
           
           while (Q.LESSTHAN(remainder1) || Q.EQUALTO(remainder1))
           {
               cout << "\nhello7";
               ...
               {
                  numerator = numerator * 10000;
                  temp1 = Q.X.NEXT_RIGHT(temp2);
                  numerator = numerator +Q.X.NODE_VALUE(temp2);
               }
               
               if(remainder1.X.GET_FIRST()!= remainder1.X.GET_LAST())
               {
                  denominator = denominator * 10000;
                  temp2 = remainder1.X.NEXT_RIGHT(temp1);
                  denominator = denominator + remainder1.X.NODE_VALUE(temp1);
               }
               ...
               result.MULTIPLY(scale10);
               result.ADD(multiplier);
               cout << "\nhello12" << endl;
               remainder2 = Q.MULTIPLY(multiplier);
               
              paddedsub.X.head = remainder2.X.head;
               
               while(remainder2.LESSTHAN(remainder1)){
                   cout << "\nremainder2: ";remainder2.PRINT();cout << " -- remainder1: ";remainder1.PRINT();cout << " -- scale10: ";scale10.PRINT();
                   cout << "\nhello10";
                      remainder2 = remainder2.MULTIPLY(scale10);
